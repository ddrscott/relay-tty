...
- [ ] Add "Add to Home Screen" guidance for iOS users to enable notifications ([detail](work-queue/add-to-homescreen-guide.md))
- [ ] Require JWT token in tunnel mode QR code URL — validate and set session cookie on first visit ([detail](work-queue/tunnel-jwt-auth.md))
- [ ] Mobile gallery page with live terminal thumbnails ([detail](work-queue/mobile-gallery.md))
