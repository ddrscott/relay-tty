...
- [ ] Fix title bar overflow: long session titles push `< num >` nav arrows offscreen
- [ ] Mic opens scratchpad without virtual keyboard ([detail](work-queue/mic-no-keyboard.md))
