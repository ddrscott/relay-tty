...
| [File Browser](file-browser.md) | Browse and view files from the web UI |
| [Voice Input](voice-input.md) | Dictate commands with Web Speech API |
| [Install as PWA](pwa-install.md) | Add to home screen for native app feel |
