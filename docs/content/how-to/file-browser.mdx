...
path**. The copied path is shell-quoted when it contains spaces or other
metacharacters, so it pastes at a prompt as a single argument. See
[Uploading Files](/how-to/uploading-files) for the full upload workflow.
