...
<Callout type="info" title="Pinch-to-zoom">
Pinch to adjust the terminal font size. The font size is saved per session — it carries over between views and persists across reconnects.
</Callout>
## Step 6: The sidebar
