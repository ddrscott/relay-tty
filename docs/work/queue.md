...
- [-] Web app: make the file viewer/editor sidebar resizable via left-border drag, persisting width in sessionStorage ([details](file-viewer-resizable-sidebar.md))
